...
## Datos de usuario
Usuario: bandit17@bandit.labs.overthewire.org 
Contraseña: {llave privada} o VwOSWtCA7lRKkTfbr2IDh6awj9RNZM5e

## Solución 
robert@DESKTOP-M9VOEL3:~$ ssh bandit17@bandit.labs.overthewire.org -p 2220
                         _                     _ _ _
                        | |__   __ _ _ __   __| (_) |_
                        | '_ \ / _` | '_ \ / _` | | __|
                        | |_) | (_| | | | | (_| | | |_
...
robert@DESKTOP-M9VOEL3:~$ ssh bandit18@bandit.labs.overthewire.org -p 2220

## Contraseña obtenida en este nivel 
hga5tuuCLF6fFzUpnagiMN8ssu9LFrdg
## Notas 
Con el comando diff fue posible revisar cada linea de archivo para ver cual es diferente en cada archivo 
