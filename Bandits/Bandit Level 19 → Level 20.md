...
## Datos de usuario
Usuario: bandit19@bandit.labs.overthewire.org
Contraseña: awhqfNnAbc1naukrpqDYcF95h7HoMTrC

## Solución 

robert@DESKTOP-M9VOEL3:~$ ssh bandit19@bandit.labs.overthewire.org -p 2220
                         _                     _ _ _
                        | |__   __ _ _ __   __| (_) |_
                        | '_ \ / _` | '_ \ / _` | | __|
                        | |_) | (_| | | | | (_| | | |_
...
VxCazJaVykI6W36BkBU0mJTCM8rR95XT
## Notas 
./bandit20-do id es un comando que nos permite realizar distintas acciones por ejemplo la ./ ejecuta al archivo bandit 20 -do e id nos permite ejecutar distintas tareas dentro de este archivo y así poder obtener la contraseña del siguiente nivel 
