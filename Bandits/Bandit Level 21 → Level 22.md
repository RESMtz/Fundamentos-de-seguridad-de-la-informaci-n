...
## Solución 
robert@DESKTOP-M9VOEL3:~$ ssh bandit21@bandit.labs.overthewire.org -p 2220
                         _                     _ _ _
                        | |__   __ _ _ __   __| (_) |_
                        | '_ \ / _` | '_ \ / _` | | __|
                        | |_) | (_| | | | | (_| | | |_
...
bandit21@bandit:~$ ls /etc/crontab
/etc/crontab
...
## Notas 
Mediante el comando cat /usr/bin/cronjob_bandit22.sh pudimos ejecutar el directorio y así pudimos obtener la constraseña oculta de nuestro nivel.